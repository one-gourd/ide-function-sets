...
import { FunctionSetsFactory } from '../../../src';
import { modelPropsGen } from '../../helper';

const {
  ComponentWithStore: FunctionSetsWithStore1,
  client: client1
} = FunctionSetsFactory();

// const {
//   FunctionSetsWithStore: FunctionSetsWithStore2,
//   client: client2
// } = FunctionSetsFactory();
  ...
  .addWithJSX('/model 获取属性信息', () => {
    return (
      <Row style={styles.demoWrap}>
        ...
        <Col span={24}>
          <FunctionSetsWithStore1 onClick={onClick} />
        </Col>
      </Row>
    );
  });